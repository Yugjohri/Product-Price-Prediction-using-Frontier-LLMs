...
## Key Learnings
1. Frontier LLMs can reason surprisingly well about prices without explicit training
2. Prompt design has a significant impact on numerical accuracy
3. Traditional neural networks still outperform LLMs on pure regression when sufficient data is available
4. Hybrid approaches offer promising future directions
